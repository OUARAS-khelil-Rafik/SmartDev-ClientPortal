            ...
            <div className="w-full max-w-md animate-fade-in-up">
                <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden hover:shadow-2xl transition-shadow duration-500">
                    <div className="p-8 pb-0 text-center">
                        <div className="w-16 h-16 bg-gradient-to-tr from-blue-600 to-indigo-600 rounded-2xl mx-auto flex items-center justify-center shadow-lg shadow-blue-500/30 mb-6 animate-scale-in-bounce hover:rotate-12 transition-transform cursor-pointer">
                            <Sparkles className="text-white animate-pulse" size={32} />
                        </div>
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white animate-fade-in-up animation-delay-200">
